...
export type PaymentTransactionFromNode<LONG = Long> = SignedTransaction<PaymentTransaction<LONG>> &
  WithId &
  WithApplicationStatus &
  WithApiMixin & {
    feeAssetId: null;
...
export type IssueTransactionFromNode<LONG = Long> = SignedTransaction<IssueTransaction<LONG>> &
  WithId &
  WithApplicationStatus &
  WithApiMixin & {
    feeAssetId: null;
...
export type LeaseTransactionFromNode<LONG = Long> = SignedTransaction<LeaseTransaction<LONG>> &
  WithId &
  WithApplicationStatus &
  WithApiMixin & {
    feeAssetId: null;
...
export type BurnTransactionFromNode<LONG = Long> = SignedTransaction<BurnTransaction<LONG>> &
  WithId &
  WithApplicationStatus &
  WithApiMixin & {
    feeAssetId: null;
...
export type ReissueTransactionFromNode<LONG = Long> = SignedTransaction<ReissueTransaction<LONG>> &
  WithId &
  WithApplicationStatus &
  WithApiMixin & {
    feeAssetId: null;
...
export type AliasTransactionFromNode<LONG = Long> = SignedTransaction<AliasTransaction<LONG>> &
  WithId &
  WithApplicationStatus &
  WithApiMixin & {
    feeAssetId: null;
...
export type DataTransactionFromNode<LONG = Long> = SignedTransaction<DataTransaction<LONG>> &
  WithId &
  WithApplicationStatus &
  WithApiMixin & {
    feeAssetId: null;
